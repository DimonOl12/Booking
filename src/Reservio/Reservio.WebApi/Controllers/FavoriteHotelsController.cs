using Reservio.Application.MediatR.FavoriteHotels.Commands.Create;
using Reservio.Application.MediatR.FavoriteHotels.Commands.Delete;
using Reservio.Application.MediatR.FavoriteHotels.Queries.IsFavorite;
