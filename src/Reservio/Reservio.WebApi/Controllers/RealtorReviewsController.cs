using Reservio.Application.MediatR.RealtorReviews.Commands.Create;
using Reservio.Application.MediatR.RealtorReviews.Commands.Delete;
using Reservio.Application.MediatR.RealtorReviews.Commands.Update;
using Reservio.Application.MediatR.RealtorReviews.Queries.GetDetails;
using Reservio.Application.MediatR.RealtorReviews.Queries.GetPage;
