using Reservio.Application.MediatR.Hotels.Commands.Create;
using Reservio.Application.MediatR.Hotels.Commands.Delete;
using Reservio.Application.MediatR.Hotels.Commands.SetArchiveStatus;
using Reservio.Application.MediatR.Hotels.Commands.Update;
using Reservio.Application.MediatR.Hotels.Queries.GetAll;
using Reservio.Application.MediatR.Hotels.Queries.GetDetails;
using Reservio.Application.MediatR.Hotels.Queries.GetMaxPrice;
using Reservio.Application.MediatR.Hotels.Queries.GetPage;
