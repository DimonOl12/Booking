using Reservio.Application.MediatR.HotelReviews.Commands.Create;
using Reservio.Application.MediatR.HotelReviews.Commands.Delete;
using Reservio.Application.MediatR.HotelReviews.Commands.Update;
using Reservio.Application.MediatR.HotelReviews.Queries.GetDetails;
using Reservio.Application.MediatR.HotelReviews.Queries.GetPage;
