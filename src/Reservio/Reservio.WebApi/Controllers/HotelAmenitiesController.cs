using Reservio.Application.MediatR.HotelAmenities.Commands.Create;
using Reservio.Application.MediatR.HotelAmenities.Commands.Delete;
using Reservio.Application.MediatR.HotelAmenities.Commands.Update;
using Reservio.Application.MediatR.HotelAmenities.Queries.GetAll;
using Reservio.Application.MediatR.HotelAmenities.Queries.GetDetails;
