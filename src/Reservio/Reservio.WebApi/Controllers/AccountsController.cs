using Reservio.Application.MediatR.Accounts.Commands.BlockUserById;
using Reservio.Application.MediatR.Accounts.Commands.CreateAdmin;
using Reservio.Application.MediatR.Accounts.Commands.Registration;
using Reservio.Application.MediatR.Accounts.Commands.ResetPassword;
using Reservio.Application.MediatR.Accounts.Commands.SendResetPasswordEmail;
using Reservio.Application.MediatR.Accounts.Commands.SetPhoto;
using Reservio.Application.MediatR.Accounts.Commands.SignIn;
using Reservio.Application.MediatR.Accounts.Commands.UnlockUserById;
using Reservio.Application.MediatR.Accounts.Commands.UpdateUserInfo;
using Reservio.Application.MediatR.Accounts.Commands.UpdateCustomersInformation;
using Reservio.Application.MediatR.Accounts.Commands.UpdateRealtorsInformation;
using Reservio.Application.MediatR.Accounts.Queries.GetCustomerPage;
using Reservio.Application.MediatR.Accounts.Queries.GetCustomersInformation;
using Reservio.Application.MediatR.Accounts.Queries.GetRealtorDatails;
using Reservio.Application.MediatR.Accounts.Queries.GetRealtorPage;
using Reservio.Application.MediatR.Accounts.Queries.GetRealtorsInformation;
using Reservio.Application.MediatR.Accounts.Queries.GetRealtorsPersonalRating;
