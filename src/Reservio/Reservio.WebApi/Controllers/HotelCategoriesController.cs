using Reservio.Application.MediatR.HotelCategories.Commands.Create;
using Reservio.Application.MediatR.HotelCategories.Commands.Delete;
using Reservio.Application.MediatR.HotelCategories.Commands.Update;
using Reservio.Application.MediatR.HotelCategories.Queries.GetAll;
using Reservio.Application.MediatR.HotelCategories.Queries.GetDetails;
