using Reservio.Application.MediatR.Citizenships.Commands.Create;
using Reservio.Application.MediatR.Citizenships.Commands.Delete;
using Reservio.Application.MediatR.Citizenships.Commands.Update;
using Reservio.Application.MediatR.Citizenships.Queries.GetAll;
using Reservio.Application.MediatR.Citizenships.Queries.GetDetails;
