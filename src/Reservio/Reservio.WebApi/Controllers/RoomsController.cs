using Reservio.Application.MediatR.Rooms.Commands.Create;
using Reservio.Application.MediatR.Rooms.Commands.Delete;
using Reservio.Application.MediatR.Rooms.Commands.Update;
using Reservio.Application.MediatR.Rooms.Queries.GetAll;
using Reservio.Application.MediatR.Rooms.Queries.GetDetails;
using Reservio.Application.MediatR.Rooms.Queries.GetDetailsByRoomVariantId;
using Reservio.Application.MediatR.Rooms.Queries.GetPage;
using Reservio.Application.MediatR.Rooms.Queries.GetRoomVariantsFreeQuantity;
