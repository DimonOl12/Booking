using Reservio.Application;
using Reservio.Application.Common.Mappings;
using Reservio.Application.Interfaces;
using Reservio.Infrastructure;
using Reservio.Infrastructure.Services;
using Reservio.WebApi.Extensions;
using Reservio.WebApi.Hubs;
using Reservio.WebApi.Middleware;
using Reservio.WebApi.Services;
using Reservio.WebApi.Services.PaginationServices.DependencyInjection;
...
builder.Services.AddAutoMapper(
	configAction => {
		configAction.AddProfile(new AssemblyMappingProfile(typeof(IReservioDbContext).Assembly));
	}
);
