...
public class ReservioDbContext(DbContextOptions<ReservioDbContext> options)
	: IdentityDbContext<
		User,
		Role,
		long,
	...
	protected override void OnModelCreating(ModelBuilder modelBuilder) {
		...
		modelBuilder.ApplyConfigurationsFromAssembly(typeof(ReservioDbContext).Assembly);
	}
