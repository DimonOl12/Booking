...
using Reservio.Infrastructure.Options;
...
namespace Reservio.Infrastructure;
...
public static class DependencyInjection {
	public static IServiceCollection AddInfrastructure(this IServiceCollection services, IConfiguration configuration) {
		...
		services.AddDbContext<ReservioDbContext>(options => {
			options.UseNpgsql(connectionString);
		});

		services.AddScoped<IReservioDbContext, ReservioDbContext>();
		...
		services
			...
			.AddEntityFrameworkStores<ReservioDbContext>()
