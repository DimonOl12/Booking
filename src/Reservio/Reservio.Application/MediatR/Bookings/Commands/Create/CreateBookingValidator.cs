...
using Reservio.Application.Models.BookingRoomVariants;
using FluentValidation;
using Microsoft.EntityFrameworkCore;

namespace Reservio.Application.MediatR.Bookings.Commands.Create;

public class CreateBookingValidator : AbstractValidator<CreateBookingCommand> {
	private readonly IReservioDbContext _context;

	public CreateBookingValidator(IValidator<CreateBankCardCommand> bankCardValidator, IExistingEntityCheckerService existingEntityCheckerService, IReservioDbContext context, ICollectionValidator collectionValidator) {
		_context = context;
